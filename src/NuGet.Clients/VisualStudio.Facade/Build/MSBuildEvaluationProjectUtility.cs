...
namespace NuGet.VisualStudio.Facade.Build
{
    internal static class MSBuildEvaluationProjectUtility
    {
        ...
        internal static void AddImportStatement(MicrosoftBuildEvaluationProject msBuildProject, string targetsPath, ImportLocation location, string ensureImportedMessage)
        {
                ...
                msBuildProject.Xml.Imports.All(import => !targetsPath.Equals(import.Project, StringComparison.OrdinalIgnoreCase)))
            {
                ...
                AddEnsureImportedTarget(msBuildProject, targetsPath, ensureImportedMessage);
        ...
        private static void AddEnsureImportedTarget(MicrosoftBuildEvaluationProject msBuildProject, string targetsPath, string ensureImportedMessage)
        {
            // get the target
            ...
            if (targetElement == null)
            {
                ...
                propertyGroup.AddProperty("ErrorText", ensureImportedMessage);
            }
